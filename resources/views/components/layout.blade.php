...
<head>
    ...
    <title>Job Board - {{$title ?? "page title name required"}}</title>
...
<div class="min-h-full">
  <nav class="bg-gray-950">
    ...
    <el-disclosure id="mobile-menu" hidden class="md:hidden [&:not([hidden])]:block">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
              ...
              <a href="/contact" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact Us</a>
      </div>
    </el-disclosure>
  </nav>
  ...
  <header class="relative bg-white shadow dark:bg-gray-800">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">{{$title ?? "Dashboard"}}</h1>
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
